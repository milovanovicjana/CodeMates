...
<body>
        ...
        <div class="container">
            <div class="row center">
                ...
                <form class="col-sm-4" method="post" action="<?=site_url("RegisteredController/changePass")?>">
                    
                    <label>&nbsp;</label>
                    <div class="form-group"> 
                        <input type="password" class="form-control" placeholder="Current Password" name="curpass" required> 
                    </div> 
                    <label>&nbsp;</label>
                    <div class="form-group"> 
                    ...
                    <div class="form-group"> 
                        <input type="password" class="form-control" placeholder="Confirm Password" name="newpassconf" required> 
                    </div> 
